...
class SungJukService:
    # 데코레이터 : 함수에 추가기능을 구현할떄 사용
    @staticmethod # 정적static 매서드: 객체화없이 바로 사용가능한 메서드
...
'''
    ...
    @staticmethod
    def read_sungjuk():
        name = input('새로운 학생 이름은: ')
        kor = int(input('새로운 학생 국어는: '))
        eng = int(input('새로운 학생 영어는: '))
        mat = int(input('새로운 학생 수학은: '))
