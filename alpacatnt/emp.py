import alpacatnt.empDAO as empdao
...
def readEmp():
    ...
    emp.append(input(f'{cnt}사원 번호는?'))
    emp.append(input(f'{cnt}사원 이름은?'))
    emp.append(input(f'{cnt}사원 성은?'))
    emp.append(input(f'{cnt}사원 이메일은?'))
    emp.append(input(f'{cnt}사원 전화번호는?'))
    emp.append(input(f'{cnt}사원 입사일은?'))
    emp.append(input(f'{cnt}사원 직책은?'))
    emp.append(input(f'{cnt}사원 급여는?'))
    emp.append(input(f'{cnt}사원 수당은? (없으면 0)'))
    emp.append(input(f'{cnt}사원 매니저 번호는? (없으면 0)'))
    emp.append(input(f'{cnt}사원 부서 번호는? (없으면 0)'))
...
def readAgainEmp(emp):
    ...
    nemp.append(input(f'수정할 사원급여는?({emp[7]})'))
    nemp.append(input(f'수정할 사원수당은?({emp[8]},없으면0)'))
    nemp.append(input(f'수정할 사원상사번호는?({emp[9]},없으면0)'))
    nemp.append(input(f'수정할 사원부서번호는?({emp[10]},없으면0)'))
