...
#  사용자/venv/py301/Lib/site-package
...
import alpacatnt.hello

alpacatnt.hello.sayHello()

# ---

from alpacatnt import hello

hello.sayHello()

# ---
from alpacatnt2 import hello2

hello2.sayHello2()

# 모듈사용하기 1 - 모듈명.함수명
import alpacatnt.calc

val = alpacatnt.calc.add(10, 5)
print(val)

# 모듈사용하기 2 - 함수명 (추천!)
from alpacatnt.calc import add
from alpacatnt.calc import div
...
# pip install pymysql # mysql 데이터베이스
# pip install fastapi

# alpacatnt.example 에 각 문제에 대한 모듈 작성

# 단위 환산
# (convertUnit/readUnit/printUnits)
import alpacatnt.example as zex
...
# 계산 결과값이 주민등록번호 마지막 자리 숫자와 일치하면 유호!
