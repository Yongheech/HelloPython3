...
# 다중 if문
# 중첩 if 문을 작성하는 경우, 조건이 많으면 다소 복작함
...
result = ''
match code:
    case 1: result = '남자(2000년 이전출생)'
    case 2: result = '여자(2000년 이전출생)'
    case 3: result = '남자(2000년 이후출생)'
    case 4: result = '여자(2000년 이후출생)'
    case _: result = '외국인이군요!'

print(result)


# 다중if 문으로 작성한 학점계산 코드를
...
# 자동 주문 시스템
menuIntro = '''
Good morning. Nice to mee you.
Where are you from?
Please select a number
1. 대한민국 2. USA 3. 中國
'''
msg = 'Would yoy like to order?'
...
# 국가 재난지원금 수령액 조회
family = int(input('가족 인원수를 입력하세요:'))
...
match endBirthYear:
    case 1 | 6:
        result = ' 월요일 구매 가능 합니다'
    case 2 | 7:
        result = ' 화요일 구매 가능 합니다'
    case 3 | 8:
        result = ' 수요일 구매 가능 합니다'
    case 4 | 9:
        result = ' 목요일 구매 가능 합니다'
    case 5 | 0:
        result = ' 금요일 구매 가능 합니다'
...
day = datetime.today().day  # 오늘 날짜의 일만 추출
